...
(null,'1145678901','Sergio Oscar Godoy', 'SergioGodoy14@gmail.com','activo cada seis horas','buena'),
(null,'1185377955','Javier Nicolas Ramirez', 'JaviiiR230@gmail.com','activo cada tres horas','muy buena'),
(null,'1191882340','Manuela Sofia Fernandez', 'SofiaFer02@gmail.com','activo cada doce horas','neutral');
...
grant select on marketplace.* to 'verificador'; 
...
GRANT SELECT, INSERT, UPDATE ON Marketplace.* TO 'moderador';
/*el grant select,insert y update que posee el usuario moderador podra leer,insertar datos y actualizar los mismos*/;
START TRANSACTION;

-- Verificar si existe el vendedor con id_vendedor = 1

SELECT COUNT(*) INTO @vendedor_count FROM vendedor WHERE id_vendedor = 1;

-- Realizar la eliminación o inserción según corresponda
...
INSERT INTO vendedor (id_vendedor, telefono, nombre_completo, email, estado_de_linea, reputacion)

VALUES (1, ‘1190872344’, ‘Rocio Sanchez’, ‘RocioSanchezz@gmail.com’, ‘activo cada dos horas’, ‘excelente’);
END IF;
COMMIT;
start transaction;
select * from vendedor;
insert into vendedor(id_vendedor,telefono,nombre_completo,email,estado_de_linea,reputacion)VALUES
(null,'1123456859','Raul Garcia','rulo534@gmail.com','activo cada cuatro horas,buena');
insert into vendedor(id_vendedor,telefono,nombre_completo,email,estado_de_linea,reputacion)VALUES
(null,'1165432119','Jimena Pimpe','pimpepp@gmail.com','activa cada dos horas','muy buena');
insert into vendedor(id_vendedor,telefono,nombre_completo,email,estado_de_linea,reputacion)VALUES
(null,'1164538764','Horacio Pereyra','Horadora@gmail.com','activo cada un dia','excelente');
insert into vendedor(id_vendedor,telefono,nombre_completo,email,estado_de_linea,reputacion)VALUES
(null,'1143257675','Maira Gole','MaiMai2@gmail.com','activa cada nueve horas','mala');
savepoint lote_01;
insert into vendedor(id_vendedor,telefono,nombre_completo,email,estado_de_linea,reputacion)VALUES
(null,'1175232456','Paulo Ramos','littleking@gmail.com','activo cada cinco horas','neutral');
insert into vendedor(id_vendedor,telefono,nombre_completo,email,estado_de_linea,reputacion)VALUES
(null,'1184574747','Magaly Medina','darknesshour@gmail.com','activa cada una hora','excelente');
insert into vendedor(id_vendedor,telefono,nombre_completo,email,estado_de_linea,reputacion)VALUES
(null,'112456898','Patricio Mora','MMmpato@gmail.com','activo cada tres horas','buena');
insert into vendedor(id_vendedor,telefono,nombre_completo,email,estado_de_linea,reputacion)VALUES
(null,'658764237','Jennifer Ulma','Jenny45@gmail.com','activa cada cinco horas','excelente');
savepoint lote_02;
release savepoint lote_01;
rollback;
/*la funcion del release savepoint lote_01 sirve para la eliminacion de los primeros 4 registros y posteriormente tiene un rollback para confirmar la eliminacion*/
